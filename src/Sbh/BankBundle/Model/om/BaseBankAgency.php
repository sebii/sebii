...
abstract class BaseBankAgency extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Sbh\\BankBundle\\Model\\BankAgencyPeer';
    ...
    /**
     * The value for the bank_group_id field.
     * @var        int
     */
    protected $bank_group_id;
    ...
    /**
     * Get the [bank_group_id] column value.
     *
     * @return int
     */
    public function getBankGroupId()
    {

        return $this->bank_group_id;
    }
     ...
     * @return BankAgency The current object (for fluent API support)
     */
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = BankAgencyPeer::NAME;
        }
    ...
    /**
     * Set the value of [bank_group_id] column.
     *
     * @param  int $v new value
     * @return BankAgency The current object (for fluent API support)
     */
    public function setBankGroupId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->bank_group_id !== $v) {
            $this->bank_group_id = $v;
            $this->modifiedColumns[] = BankAgencyPeer::BANK_GROUP_ID;
        }

        if ($this->aBankGroup !== null && $this->aBankGroup->getId() !== $v) {
            $this->aBankGroup = null;
        }
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = BankAgencyPeer::SLUG;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BankAgencyPeer::ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BankAgencyPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BankAgencyPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->bank_group_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 6; // 6 = BankAgencyPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BankAgency object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aBankGroup !== null && $this->bank_group_id !== $this->aBankGroup->getId()) {
            $this->aBankGroup = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BankAgencyPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BankAgencyQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
      ...
      if ($this->isColumnModified(BankAgencyPeer::SLUG) && $this->getSlug())
      {
      ...
      else
      {
        ...
        if (!$this->isColumnModified(BankAgencyPeer::CREATED_AT))
        {
            $this->setCreatedAt(time());
        }
        if (!$this->isColumnModified(BankAgencyPeer::UPDATED_AT))
        {
        ...
        // timestampable behavior
        if ($this->isModified() && !$this->isColumnModified(BankAgencyPeer::UPDATED_AT))
        {
            $this->setUpdatedAt(time());
        }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                BankAgencyPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aBankGroup !== null) {
                if ($this->aBankGroup->isModified() || $this->aBankGroup->isNew()) {
                    $affectedRows += $this->aBankGroup->save($con);
                }
                $this->setBankGroup($this->aBankGroup);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BankAgencyPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(BankAgencyPeer::BANK_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`bank_group_id`';
        }
        if ($this->isColumnModified(BankAgencyPeer::SLUG)) {
            $modifiedColumns[':p' . $index++]  = '`slug`';
        }
        if ($this->isColumnModified(BankAgencyPeer::ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `bank_agency` (%s) VALUES (%s)',
        ...
        try {
            ...
            $stmt->bindValue($identifier, $this->name, PDO::PARAM_STR);
                        break;
                    case '`bank_group_id`':
            $stmt->bindValue($identifier, $this->bank_group_id, PDO::PARAM_INT);
                        break;
                    case '`slug`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aBankGroup !== null) {
                if (!$this->aBankGroup->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aBankGroup->getValidationFailures());
                }
            }


            if (($retval = BankAgencyPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BankAgencyPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BankAgency'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BankAgency'][$this->getPrimaryKey()] = true;
        $keys = BankAgencyPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getName(),
            $keys[1] => $this->getBankGroupId(),
            $keys[2] => $this->getSlug(),
            $keys[3] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aBankGroup) {
                $result['BankGroup'] = $this->aBankGroup->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setBankGroupId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BankAgencyPeer::NAME)) $criteria->add(BankAgencyPeer::NAME, $this->name);
        if ($this->isColumnModified(BankAgencyPeer::BANK_GROUP_ID)) $criteria->add(BankAgencyPeer::BANK_GROUP_ID, $this->bank_group_id);
        if ($this->isColumnModified(BankAgencyPeer::SLUG)) $criteria->add(BankAgencyPeer::SLUG, $this->slug);
        if ($this->isColumnModified(BankAgencyPeer::ID)) $criteria->add(BankAgencyPeer::ID, $this->id);
        if ($this->isColumnModified(BankAgencyPeer::CREATED_AT)) $criteria->add(BankAgencyPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(BankAgencyPeer::UPDATED_AT)) $criteria->add(BankAgencyPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(BankAgencyPeer::DATABASE_NAME);
        $criteria->add(BankAgencyPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of BankAgency (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setBankGroupId($this->getBankGroupId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BankAgency Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BankAgencyPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BankAgencyPeer();
        }
    ...
    /**
     * Declares an association between this object and a BankGroup object.
     *
     * @param                  BankGroup $v
     * @return BankAgency The current object (for fluent API support)
     * @throws PropelException
     */
    public function setBankGroup(BankGroup $v = null)
    {
        if ($v === null) {
            $this->setBankGroupId(NULL);
        } else {
            $this->setBankGroupId($v->getId());
        }

        $this->aBankGroup = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the BankGroup object, it will not be re-added.
        if ($v !== null) {
            $v->addBankAgency($this);
        }
    ...
    /**
     * Get the associated BankGroup object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return BankGroup The associated BankGroup object.
     * @throws PropelException
     */
    public function getBankGroup(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBankGroup === null && ($this->bank_group_id !== null) && $doQuery) {
            $this->aBankGroup = BankGroupQuery::create()->findPk($this->bank_group_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBankGroup->addBankAgencies($this);
             */
        }

        return $this->aBankGroup;
    }
     ...
     * If this BankAgency is new, it will return
    ...
    public function setBankAccounts(PropelCollection $bankAccounts, PropelPDO $con = null)
    {
        ...
        foreach ($bankAccountsToDelete as $bankAccountRemoved) {
            $bankAccountRemoved->setBankAgency(null);
        }
    ...
    protected function doAddBankAccount($bankAccount)
    {
        ...
        $bankAccount->setBankAgency($this);
    }
    ...
    public function removeBankAccount($bankAccount)
    {
        if ($this->getBankAccounts()->contains($bankAccount)) {
            ...
            $this->bankAccountsScheduledForDeletion[]= $bankAccount;
            $bankAccount->setBankAgency(null);
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aBankGroup instanceof Persistent) {
              $this->aBankGroup->clearAllReferences($deep);
            }
  ...
  protected function makeSlugUnique($slug, $separator = '-', $alreadyExists = false)
  {
      if (!$alreadyExists) {
       ...
       $query = BankAgencyQuery::create('q')
