...
abstract class BaseBankFrequentOperation extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Sbh\\BankBundle\\Model\\BankFrequentOperationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BankFrequentOperationPeer
     */
     ...
     * @return BankFrequentOperation The current object (for fluent API support)
     */
    public function setBankAccountId($v)
    {
        ...
        if ($this->bank_account_id !== $v) {
            ...
            $this->modifiedColumns[] = BankFrequentOperationPeer::BANK_ACCOUNT_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = BankFrequentOperationPeer::NAME;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BankFrequentOperationPeer::DATE;
            }
    ...
    public function setBankPayeeId($v)
    {
        ...
        if ($this->bank_payee_id !== $v) {
            ...
            $this->modifiedColumns[] = BankFrequentOperationPeer::BANK_PAYEE_ID;
        }
    ...
    public function setBankCategoryId($v)
    {
        ...
        if ($this->bank_category_id !== $v) {
            ...
            $this->modifiedColumns[] = BankFrequentOperationPeer::BANK_CATEGORY_ID;
        }
    ...
    public function setPayment($v)
    {
        ...
        if ($this->payment !== $v) {
            $this->payment = $v;
            $this->modifiedColumns[] = BankFrequentOperationPeer::PAYMENT;
        }
    ...
    public function setDeposit($v)
    {
        ...
        if ($this->deposit !== $v) {
            $this->deposit = $v;
            $this->modifiedColumns[] = BankFrequentOperationPeer::DEPOSIT;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BankFrequentOperationPeer::ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BankFrequentOperationPeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BankFrequentOperationPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = BankFrequentOperationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BankFrequentOperation object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BankFrequentOperationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BankFrequentOperationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        if (!$this->isColumnModified(BankFrequentOperationPeer::CREATED_AT))
        {
            $this->setCreatedAt(time());
        }
        if (!$this->isColumnModified(BankFrequentOperationPeer::UPDATED_AT))
        {
        ...
        // timestampable behavior
        if ($this->isModified() && !$this->isColumnModified(BankFrequentOperationPeer::UPDATED_AT))
        {
            $this->setUpdatedAt(time());
        }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                BankFrequentOperationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BankFrequentOperationPeer::BANK_ACCOUNT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`bank_account_id`';
        }
        if ($this->isColumnModified(BankFrequentOperationPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(BankFrequentOperationPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(BankFrequentOperationPeer::BANK_PAYEE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`bank_payee_id`';
        }
        if ($this->isColumnModified(BankFrequentOperationPeer::BANK_CATEGORY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`bank_category_id`';
        }
        if ($this->isColumnModified(BankFrequentOperationPeer::PAYMENT)) {
            $modifiedColumns[':p' . $index++]  = '`payment`';
        }
        if ($this->isColumnModified(BankFrequentOperationPeer::DEPOSIT)) {
            $modifiedColumns[':p' . $index++]  = '`deposit`';
        }
        if ($this->isColumnModified(BankFrequentOperationPeer::ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `bank_frequent_operation` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BankFrequentOperationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BankFrequentOperationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BankFrequentOperation'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BankFrequentOperation'][$this->getPrimaryKey()] = true;
        $keys = BankFrequentOperationPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BankFrequentOperationPeer::BANK_ACCOUNT_ID)) $criteria->add(BankFrequentOperationPeer::BANK_ACCOUNT_ID, $this->bank_account_id);
        if ($this->isColumnModified(BankFrequentOperationPeer::NAME)) $criteria->add(BankFrequentOperationPeer::NAME, $this->name);
        if ($this->isColumnModified(BankFrequentOperationPeer::DATE)) $criteria->add(BankFrequentOperationPeer::DATE, $this->date);
        if ($this->isColumnModified(BankFrequentOperationPeer::BANK_PAYEE_ID)) $criteria->add(BankFrequentOperationPeer::BANK_PAYEE_ID, $this->bank_payee_id);
        if ($this->isColumnModified(BankFrequentOperationPeer::BANK_CATEGORY_ID)) $criteria->add(BankFrequentOperationPeer::BANK_CATEGORY_ID, $this->bank_category_id);
        if ($this->isColumnModified(BankFrequentOperationPeer::PAYMENT)) $criteria->add(BankFrequentOperationPeer::PAYMENT, $this->payment);
        if ($this->isColumnModified(BankFrequentOperationPeer::DEPOSIT)) $criteria->add(BankFrequentOperationPeer::DEPOSIT, $this->deposit);
        if ($this->isColumnModified(BankFrequentOperationPeer::ID)) $criteria->add(BankFrequentOperationPeer::ID, $this->id);
        if ($this->isColumnModified(BankFrequentOperationPeer::CREATED_AT)) $criteria->add(BankFrequentOperationPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(BankFrequentOperationPeer::UPDATED_AT)) $criteria->add(BankFrequentOperationPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(BankFrequentOperationPeer::DATABASE_NAME);
        $criteria->add(BankFrequentOperationPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of BankFrequentOperation (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BankFrequentOperation Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BankFrequentOperationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BankFrequentOperationPeer();
        }
    ...
    public function setBankAccount(BankAccount $v = null)
    {
        ...
        if ($v !== null) {
            $v->addBankFrequentOperation($this);
        }
    ...
    public function getBankAccount(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBankAccount === null && ($this->bank_account_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBankAccount->addBankFrequentOperations($this);
             */
        }
    ...
    public function getBankPayee(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBankPayee === null && ($this->bank_payee_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBankPayee->addBankFrequentOperations($this);
             */
        }
    ...
    public function getBankCategory(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBankCategory === null && ($this->bank_category_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBankCategory->addBankFrequentOperations($this);
             */
        }
     ...
     * If this BankFrequentOperation is new, it will return
        ...
        if (null === $this->collBankOperations || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collBankOperations) {
                ...
                $collBankOperations = BankOperationQuery::create(null, $criteria)
                    ->filterByBankFrequentOperation($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setBankOperations(PropelCollection $bankOperations, PropelPDO $con = null)
    {
        ...
        foreach ($bankOperationsToDelete as $bankOperationRemoved) {
            $bankOperationRemoved->setBankFrequentOperation(null);
        }
    ...
    protected function doAddBankOperation($bankOperation)
    {
        ...
        $bankOperation->setBankFrequentOperation($this);
    }
    ...
    public function removeBankOperation($bankOperation)
    {
        if ($this->getBankOperations()->contains($bankOperation)) {
            ...
            $bankOperation->setBankFrequentOperation(null);
        }
     ...
     * Otherwise if this BankFrequentOperation is new, it will return
     * an empty collection; or if this BankFrequentOperation has previously
     * been saved, it will retrieve related BankOperations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in BankFrequentOperation.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|BankOperation[] List of BankOperation objects
     */
    public function getBankOperationsJoinBankCategory($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = BankOperationQuery::create(null, $criteria);
        $query->joinWith('BankCategory', $join_behavior);
    ...
    {
        return (string) $this->exportTo(BankFrequentOperationPeer::DEFAULT_STRING_FORMAT);
    }
