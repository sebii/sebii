...
abstract class BaseBankAccount extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Sbh\\BankBundle\\Model\\BankAccountPeer';
    ...
    /**
     * The value for the bank_agency_id field.
     * @var        int
     */
    protected $bank_agency_id;
    ...
    public function getType()
    {
        ...
        $valueSet = BankAccountPeer::getValueSet(BankAccountPeer::TYPE);
    ...
    /**
     * Get the [bank_agency_id] column value.
     *
     * @return int
     */
    public function getBankAgencyId()
    {

        return $this->bank_agency_id;
    }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = BankAccountPeer::USER_ID;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = BankAccountPeer::TYPE;
        }
    ...
    /**
     * Set the value of [bank_agency_id] column.
     *
     * @param  int $v new value
     * @return BankAccount The current object (for fluent API support)
     */
    public function setBankAgencyId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->bank_agency_id !== $v) {
            $this->bank_agency_id = $v;
            $this->modifiedColumns[] = BankAccountPeer::BANK_AGENCY_ID;
        }

        if ($this->aBankAgency !== null && $this->aBankAgency->getId() !== $v) {
            $this->aBankAgency = null;
        }
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = BankAccountPeer::SLUG;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->bank_agency_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            ...
            return $startcol + 8; // 8 = BankAccountPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aBankAgency !== null && $this->bank_agency_id !== $this->aBankAgency->getId()) {
            $this->aBankAgency = null;
        }
    } // ensureConsistency
    ...
    public function save(PropelPDO $con = null)
    {
      ...
      if ($this->isColumnModified(BankAccountPeer::SLUG) && $this->getSlug())
      {
      ...
      else
      {
        ...
        if (!$this->isColumnModified(BankAccountPeer::UPDATED_AT))
        {
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aBankAgency !== null) {
                if ($this->aBankAgency->isModified() || $this->aBankAgency->isNew()) {
                    $affectedRows += $this->aBankAgency->save($con);
                }
                $this->setBankAgency($this->aBankAgency);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BankAccountPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(BankAccountPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(BankAccountPeer::TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`type`';
        }
        if ($this->isColumnModified(BankAccountPeer::BANK_AGENCY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`bank_agency_id`';
        }
        if ($this->isColumnModified(BankAccountPeer::SLUG)) {
        ...
        try {
            ...
            $stmt->bindValue($identifier, $this->type, PDO::PARAM_INT);
                        break;
                    case '`bank_agency_id`':
            $stmt->bindValue($identifier, $this->bank_agency_id, PDO::PARAM_INT);
                        break;
                    case '`slug`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aBankAgency !== null) {
                if (!$this->aBankAgency->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aBankAgency->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aBankAgency) {
                $result['BankAgency'] = $this->aBankAgency->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setBankAgencyId($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BankAccountPeer::USER_ID)) $criteria->add(BankAccountPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(BankAccountPeer::TYPE)) $criteria->add(BankAccountPeer::TYPE, $this->type);
        if ($this->isColumnModified(BankAccountPeer::BANK_AGENCY_ID)) $criteria->add(BankAccountPeer::BANK_AGENCY_ID, $this->bank_agency_id);
        if ($this->isColumnModified(BankAccountPeer::SLUG)) $criteria->add(BankAccountPeer::SLUG, $this->slug);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setBankAgencyId($this->getBankAgencyId());
    ...
    /**
     * Declares an association between this object and a BankAgency object.
     *
     * @param                  BankAgency $v
     * @return BankAccount The current object (for fluent API support)
     * @throws PropelException
     */
    public function setBankAgency(BankAgency $v = null)
    {
        if ($v === null) {
            $this->setBankAgencyId(NULL);
        } else {
            $this->setBankAgencyId($v->getId());
        }

        $this->aBankAgency = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the BankAgency object, it will not be re-added.
        if ($v !== null) {
    ...
    /**
     * Get the associated BankAgency object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return BankAgency The associated BankAgency object.
     * @throws PropelException
     */
    public function getBankAgency(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBankAgency === null && ($this->bank_agency_id !== null) && $doQuery) {
            $this->aBankAgency = BankAgencyQuery::create()->findPk($this->bank_agency_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBankAgency->addBankAccounts($this);
             */
        }

        return $this->aBankAgency;
    }
    ...
    public function setBankFrequentOperations(PropelCollection $bankFrequentOperations, PropelPDO $con = null)
    {
        ...
        foreach ($bankFrequentOperationsToDelete as $bankFrequentOperationRemoved) {
            $bankFrequentOperationRemoved->setBankAccount(null);
        }
    ...
    protected function doAddBankFrequentOperation($bankFrequentOperation)
    {
        ...
        $bankFrequentOperation->setBankAccount($this);
    }
    ...
    public function removeBankFrequentOperation($bankFrequentOperation)
    {
        if ($this->getBankFrequentOperations()->contains($bankFrequentOperation)) {
            ...
            $bankFrequentOperation->setBankAccount(null);
        }
     ...
     * @return PropelObjectCollection|BankFrequentOperation[] List of BankFrequentOperation objects
     */
    public function getBankFrequentOperationsJoinBankCategory($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = BankFrequentOperationQuery::create(null, $criteria);
    ...
    public function setBankOperations(PropelCollection $bankOperations, PropelPDO $con = null)
    {
        ...
        foreach ($bankOperationsToDelete as $bankOperationRemoved) {
            $bankOperationRemoved->setBankAccount(null);
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aBankAgency instanceof Persistent) {
              $this->aBankAgency->clearAllReferences($deep);
            }
  ...
  protected function makeSlugUnique($slug, $separator = '-', $alreadyExists = false)
  {
      if (!$alreadyExists) {
       ...
       $query = BankAccountQuery::create('q')
