...
abstract class BaseBankPayee extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Sbh\\BankBundle\\Model\\BankPayeePeer';
     ...
     * @return BankPayee The current object (for fluent API support)
     */
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = BankPayeePeer::NAME;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = BankPayeePeer::USER_ID;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BankPayeePeer::ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BankPayeePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BankPayeePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = BankPayeePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BankPayee object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BankPayeePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BankPayeeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        if (!$this->isColumnModified(BankPayeePeer::CREATED_AT))
        {
            $this->setCreatedAt(time());
        }
        if (!$this->isColumnModified(BankPayeePeer::UPDATED_AT))
        {
        ...
        // timestampable behavior
        if ($this->isModified() && !$this->isColumnModified(BankPayeePeer::UPDATED_AT))
        {
            $this->setUpdatedAt(time());
        }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                BankPayeePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BankPayeePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(BankPayeePeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(BankPayeePeer::ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `bank_payee` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BankPayeePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BankPayeePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BankPayee'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BankPayee'][$this->getPrimaryKey()] = true;
        $keys = BankPayeePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BankPayeePeer::NAME)) $criteria->add(BankPayeePeer::NAME, $this->name);
        if ($this->isColumnModified(BankPayeePeer::USER_ID)) $criteria->add(BankPayeePeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(BankPayeePeer::ID)) $criteria->add(BankPayeePeer::ID, $this->id);
        if ($this->isColumnModified(BankPayeePeer::CREATED_AT)) $criteria->add(BankPayeePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(BankPayeePeer::UPDATED_AT)) $criteria->add(BankPayeePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(BankPayeePeer::DATABASE_NAME);
        $criteria->add(BankPayeePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of BankPayee (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BankPayee Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BankPayeePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BankPayeePeer();
        }
     ...
     * If this BankPayee is new, it will return
    ...
    public function setBankFrequentOperations(PropelCollection $bankFrequentOperations, PropelPDO $con = null)
    {
        ...
        foreach ($bankFrequentOperationsToDelete as $bankFrequentOperationRemoved) {
            $bankFrequentOperationRemoved->setBankPayee(null);
        }
    ...
    protected function doAddBankFrequentOperation($bankFrequentOperation)
    {
        ...
        $bankFrequentOperation->setBankPayee($this);
    }
    ...
    public function removeBankFrequentOperation($bankFrequentOperation)
    {
        if ($this->getBankFrequentOperations()->contains($bankFrequentOperation)) {
            ...
            $bankFrequentOperation->setBankPayee(null);
        }
     ...
     * Otherwise if this BankPayee is new, it will return
     * an empty collection; or if this BankPayee has previously
     * been saved, it will retrieve related BankFrequentOperations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in BankPayee.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setBankOperations(PropelCollection $bankOperations, PropelPDO $con = null)
    {
        ...
        foreach ($bankOperationsToDelete as $bankOperationRemoved) {
            $bankOperationRemoved->setBankPayee(null);
        }
    ...
    protected function doAddBankOperation($bankOperation)
    {
        ...
        $bankOperation->setBankPayee($this);
    }
    ...
    public function removeBankOperation($bankOperation)
    {
        if ($this->getBankOperations()->contains($bankOperation)) {
            ...
            $bankOperation->setBankPayee(null);
        }
    ...
    {
        return (string) $this->exportTo(BankPayeePeer::DEFAULT_STRING_FORMAT);
    }
