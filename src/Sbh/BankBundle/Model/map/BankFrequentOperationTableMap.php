...
/**
 * This class defines the structure of the 'bank_frequent_operation' table.
 *
 *
 *
 ...
 */
class BankFrequentOperationTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Sbh.BankBundle.Model.map.BankFrequentOperationTableMap';
    ...
    {
        // attributes
        $this->setName('bank_frequent_operation');
        $this->setPhpName('BankFrequentOperation');
        $this->setClassname('Sbh\\BankBundle\\Model\\BankFrequentOperation');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('BankOperation', 'Sbh\\BankBundle\\Model\\BankOperation', RelationMap::ONE_TO_MANY, array('id' => 'bank_frequent_operation_id', ), 'SET NULL', 'CASCADE', 'BankOperations');
    } // buildRelations()
