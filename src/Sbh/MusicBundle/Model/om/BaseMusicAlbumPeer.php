...
abstract class BaseMusicAlbumPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Name', 'ArtistId', 'Alias', 'Id', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('name', 'artistId', 'alias', 'id', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (MusicAlbumPeer::NAME, MusicAlbumPeer::ARTIST_ID, MusicAlbumPeer::ALIAS, MusicAlbumPeer::ID, MusicAlbumPeer::CREATED_AT, MusicAlbumPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('NAME', 'ARTIST_ID', 'ALIAS', 'ID', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('name', 'artist_id', 'alias', 'id', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Name' => 0, 'ArtistId' => 1, 'Alias' => 2, 'Id' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('name' => 0, 'artistId' => 1, 'alias' => 2, 'id' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        BasePeer::TYPE_COLNAME => array (MusicAlbumPeer::NAME => 0, MusicAlbumPeer::ARTIST_ID => 1, MusicAlbumPeer::ALIAS => 2, MusicAlbumPeer::ID => 3, MusicAlbumPeer::CREATED_AT => 4, MusicAlbumPeer::UPDATED_AT => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('NAME' => 0, 'ARTIST_ID' => 1, 'ALIAS' => 2, 'ID' => 3, 'CREATED_AT' => 4, 'UPDATED_AT' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('name' => 0, 'artist_id' => 1, 'alias' => 2, 'id' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
